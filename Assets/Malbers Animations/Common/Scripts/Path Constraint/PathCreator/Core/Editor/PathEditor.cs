...
namespace MalbersAnimations.PathCreation
{
    ...
    public class PathEditor : Editor
    {
        ...
        // Dictionary<HandleType, Handles.CapFunction> capFunctions;
        ...
        void ProcessBezierPathInput(Event e)
        {
            ...
            for (int i = 0; i < bezierPath.NumPoints; i += 3)
            {
                ...
                float handleRadius = GetHandleDiameter(globalDisplaySettings.anchorSize, bezierPath[handleIndex]) / 2f;
        ...
        void DrawHandle(int i)
        {
            ...
            float anchorHandleSize = GetHandleDiameter(globalDisplaySettings.anchorSize, bezierPath[i]);
            float controlHandleSize = GetHandleDiameter(globalDisplaySettings.controlSize, bezierPath[i]);
            ...
            handlePosition = PathHandle.DrawHandle
                (handlePosition, bezierPath.Space, isInteractive, handleSize, Handles.SphereHandleCap, handleColours, out handleInputType, i);
        ...
        void LoadDisplaySettings()
        {
            ...
            // capFunctions = new Dictionary<HandleType, Handles.CapFunction> ();
            // capFunctions.Add (  HandleType.Circle, Handles.CylinderHandleCap);
            //// capFunctions.Add (  HandleType.Sphere, Handles.SphereHandleCap);
            //// capFunctions.Add (  HandleType.Square, Handles.CubeHandleCap);
        }
