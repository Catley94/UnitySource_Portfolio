...
namespace DistantLands.Cozy
{
    ...
    public class MeridiemTime
    {
        ...
        public static float MeridiemTimeToDayPercent(int hours, int minutes, Meridiem meridiem)
        {
        ...
        {
            return (((float)time.hours + (float)time.minutes / 60) / 24) + (time.meridiem == Meridiem.PM ? 0.5f : 0);//Total ticks * 0.5f 
        }
